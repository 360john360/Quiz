                ...
                <div class="hpanel">
                    <div class="panel-body">
                        <form action="" name="form1" method="post">
                            ...
                            <div class="alert alert-success" id="success" style="margain-top: 10px; display: none">
                                <strong>Success!</strong> Account is now registered.
                            </div>
                            <div class="alert alert-danger" id="failed" style="margain-top: 10px; display: none">
                                <strong>The username you select cannot be used, try another one.</strong> This username is already taken.
                            </div>
                        </form>
                    </div>
                </div>
